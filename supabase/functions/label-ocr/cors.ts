 ...
 *
 * Same policy as analyze-skin, paypal and mfds-ingredients, duplicated rather
 * than shared because edge functions deploy as separate bundles and cannot
 * import across folders. If you change one, change all four.
 */
