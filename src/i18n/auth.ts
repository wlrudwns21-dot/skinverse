...
export const authStrings: Record<Lang, AuthStrings> = {
  ko: {
    ...
    customsHelp: '배송받으실 때 통관에 쓰입니다. 나중에 입력해도 됩니다.',
  ...
  en: {
    ...
    customsHelp: 'Used to clear customs on your delivery. You can add it later.',
  ...
  th: {
    ...
    customsHelp: 'ใช้สำหรับพิธีการศุลกากรตอนจัดส่ง กรอกภายหลังได้',
