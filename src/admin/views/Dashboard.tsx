    ...
    <div style={s('animation:riseAdmin .3s ease both')}>
      <div style={s('display:flex;justify-content:space-between;align-items:baseline;flex-wrap:wrap;gap:8px')}>
        ...
        <div style={s('display:flex;align-items:center;gap:12px')}>
          <div style={s('font-size:12px;color:#8A7D6C')}>{today} · 오늘 기준</div>
          <div onClick={admin.refresh} style={s('cursor:pointer;border:1px solid #D8CFBF;border-radius:999px;padding:6px 12px;font-size:12px;font-weight:600;background:#FFFFFF')}>
      ...
      <div style={s('display:grid;grid-template-columns:minmax(0,1.4fr) minmax(0,1fr);gap:12px;margin-top:12px')}>
        ...
        <div style={s('background:#FFFFFF;border:1px solid #ECE6DA;border-radius:14px;padding:16px')}>
          <div style={s('font-size:13px;font-weight:700')}>가입 → 구매 전환</div>
          ...
          <div style={s('font-size:11.5px;color:#8A7D6C;margin-top:10px;line-height:1.5')}>
            회원 대비 구매 전환율 <b style={s('color:#2E6B58')}>{admin.conversionRate}</b>
